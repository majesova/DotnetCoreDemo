    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_account_stores", x => new { x.account_id, x.store_id });
                    table.ForeignKey(
                        name: "fk_account_stores_asp_net_users_account_id",
                        column: x => x.account_id,
                        principalTable: "asp_net_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_account_stores_stores_store_id",
                        column: x => x.store_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_account_stores_store_id",
                table: "account_stores",
                column: "store_id");
